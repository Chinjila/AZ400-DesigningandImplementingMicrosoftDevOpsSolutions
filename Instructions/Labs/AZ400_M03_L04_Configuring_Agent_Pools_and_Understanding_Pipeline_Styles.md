...
In this lab, you'll step through using a YAML-based pipeline and running it using a self-hosted agent.
...
In this lab, you learned how run a YAML based pipeline using self-hosted agents.
